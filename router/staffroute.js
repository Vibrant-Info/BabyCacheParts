module.exports=function(app,passport,connection){
	...
	app.post('/addStaff',function(req,res){
		var loginnnamecheck=connection.query("SELECT loginname FROM stafflogin where loginname='"+req.body.loginname+"'",function(err,rows){
			console.log(loginnnamecheck.sql);
			if(err){
				return err;
			}
				...
				res.send("0");
				 ...
				 var insert=connection.query("INSERT INTO `staff` (`initial`,`firstname`,`lastname`,`emailid`,`storeid`)VALUES('"+req.body.initial+"','"+req.body.firstname+"','"+req.body.lastname+"','"+req.body.emailid+"','"+req.body.storeid+"')",req.body,function(err,result){
